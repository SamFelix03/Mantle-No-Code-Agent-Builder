...
export function AgentWalletModal({ open, onOpenChange }: AgentWalletModalProps) {
  ...
  const [tokenBalances, setTokenBalances] = useState<{ mnt: string } | null>(null)
  ...
  const displayBalance = tokenBalances?.mnt || "0.00"
      ...
      >
        {hasWallet ? (
          <>
            ...
            <span className="font-semibold">{displayBalance} MNT</span>
          </>
        ) : (
          <>
